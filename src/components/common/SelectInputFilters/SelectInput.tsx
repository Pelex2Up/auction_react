...
export const SelectInputFilters: FC<SelectInputPropsT> = ({ optionsList, selectedOption, defaultOption = 'Выбрать вариант', setSelectedValue, ...rest }) => {
  ...
  return (
    <div ref={menuRef} className={`${rest.className} ${styles.wrapper}`} onClick={toggleOptions}>
