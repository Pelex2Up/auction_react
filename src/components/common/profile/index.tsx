  ...
  return (
    ...
    >
      <div
        ...
        style={{ width: '100%', height: 40, justifyContent: 'flex-start', alignItems: 'center', gap: 6, display: 'inline-flex', cursor: 'pointer' }}
      >
        <img src={props.avatar ? props.avatar : userImage} alt="avatar" />
        <div
          style={{
            color: '#808080',
            fontSize: 14,
      ...
      <ul className={`absolute left-[-80%] right-0 top-[110%] w-full z-10 cursor-default transition-all ease-out duration-500 ${show ? '' : 'hidden'}`}>
        <div className="w-[260px] bg-white rounded shadow relative">
          <div className="inline-flex px-6 py-3 items-center justify-between w-full text-zinc-900 text-base font-normal leading-tight tracking-tight">
            {user?.username}
            <svg
              width="24"
              height="24"
