  ...
  return (
    <div className="w-screen xl:px-[50px] px-[20px] py-6 flex flex-col gap-[24px] bg-[#F6F6F6] relative">
      ...
      <div className="flex xl:flex-row flex-col justify-between items-start xl:w-[80%] h-auto w-full gap-[20px]">
        ...
        <div
          className={`flex flex-col gap-[12px] w-max-content justify-start items-start ${styles.btnGroup}`}
        >
        ...
        <div
          className={`flex flex-col gap-[12px] justify-start items-start text-sm leading-[16.8px] tracking-[1%] font-normal w-max-content`}
        >
          <span>Контакты</span>
          <a
